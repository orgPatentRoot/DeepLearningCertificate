...
- this is based on https://github.com/allenai/bi-att-flow
updated from original version 0.11 to 1.0
accoring to seominjoon, it has been reported that the performance drops significantly (>5%) when trained on TF 1.0 after upgrade
