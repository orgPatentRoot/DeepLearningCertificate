...
class srn_graph(object):
    def __init__(self, hidden_size, vocabulary_size, num_unfoldings, batch_size):
        ...
        with self._graph.as_default():
            ...
            # Use a SRN cell following the definition given in Mikolov et al. 2015.
            def srn_cell(x, h):
            ...
            for i in range(self._num_unfoldings):
                ...
                training_output, training_hidden = srn_cell(training_input, training_hidden)
            ...
            validation_output, validation_hidden = srn_cell(self._validation_input, validation_hidden_saved)
